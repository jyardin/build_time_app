...
class Screen79 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final deserialized = serializers.deserializeWith(Model79.serializer, serialized);
    print(deserialized);
    return _buildContent(context, '');
  }

  Widget _buildContent(BuildContext context, String name) {
    return  TextButton(onPressed: () => showScreen(context, model: Model80()), child: const Text('Screen80'));
  }
