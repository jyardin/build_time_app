...
class Screen69 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final deserialized = serializers.deserializeWith(Model69.serializer, serialized);
    print(deserialized);
    return _buildContent(context, '');
  }

  Widget _buildContent(BuildContext context, String name) {
    return  TextButton(onPressed: () => showScreen(context, model: Model70()), child: const Text('Screen70'));
  }
