...
class Screen86 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final deserialized = serializers.deserializeWith(Model86.serializer, serialized);
    print(deserialized);
    return _buildContent(context, '');
  }

  Widget _buildContent(BuildContext context, String name) {
    return  TextButton(onPressed: () => showScreen(context, model: Model87()), child: const Text('Screen87'));
  }
