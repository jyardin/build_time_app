...
class Screen54 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final deserialized = serializers.deserializeWith(Model54.serializer, serialized);
    print(deserialized);
    return _buildContent(context, '');
  }

  Widget _buildContent(BuildContext context, String name) {
    return  TextButton(onPressed: () => showScreen(context, model: Model55()), child: const Text('Screen55'));
  }
